  ...
  return (
    <Container sx={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', rowGap: '24px'}}>
      ...
      <Stack sx={{width: "50%"}} direction="row" useFlexGap justifyContent="space-between">
        ...
        {!copied ? (
          <Button id="copy-btn" onClick={handleCopy} sx={{color: "black", borderColor: "black", height: "30px", width: "fit-content"}} variant="outlined" startIcon={<FontAwesomeIcon icon={faCopy} />} >
            Copy
          </Button>
        ): (
          <Button color="success" id="copy-btn" sx={{height: "30px", width: "fit-content"}} variant="outlined" >
            Copied
          </Button>
        )}
      </Stack>
